            ...
            collector.on('collect', (reaction, reactor) => {
                ...
                switch (reaction.emoji.name)
                {
                    ...
                    case '✅':
                        ...
                        member.roles.add(fetchRole(member.guild, roleIDs.announcer));
                        break;
                    default:
                        console.log("No >:(");
...
client.on('messageCreate', async message =>{
    ...
    let announcerRole = fetchRole(message.guild, roleIDs.announcer)
    if (message.member.roles.cache.has(announcerRole))
    {
        console.log(`No more announcer for ${message.member.user.username}`);
        message.member.roles.remove(announcerRole);
    }
});
