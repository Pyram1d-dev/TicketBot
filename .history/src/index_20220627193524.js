    ...
    switch (interaction.commandName)
    {
        case 'request':
            ...
            if (user.id in cooldowns)
            {
                ...
                {
                    await interaction.reply({content: `You are still banned from requesting tickets. Please wait ${truncateFloat(cooldowns[user.id]['banTime'] - timeElapsed, 1)}.`, ephemeral: true}).catch(console.error);
                    break;
                }
            }
